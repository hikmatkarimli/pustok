...
<div class="site-header header-4 mb--20 d-none d-lg-block">
                    ...
                    <div class="main-navigation flex-lg-right">
                        <div class="cart-widget">
                            <div class="login-block">
                                <a href="{{route('login-register')}}" class="font-weight-bold">Login</a> <br>
                                <span>or</span><a href="{{route('login-register')}}">Register</a>
                            </div>
    ...
    <div class="header-bottom">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <nav class="category-nav primary-nav @if (Route::is('home')) show @endif">
                        <div>
