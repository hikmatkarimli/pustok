                                ...
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{route('product-details')}}">Find Out More About BOOK ?</a>
                                            </h3>
                                        </div>
                                        <div class="price-block">
                                            <span class="price">£51.20</span>
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            ...
                                            <div class="hover-contents">
                                                <a href="{{route('product-details')}}" class="hover-image">
                                                    <img src="{{asset('front/assets/image/products/product-2.jpg')}}"
                                                        alt="">
                                                </a>
                                                <div class="hover-btns">
                                                    <a href="{{route('cart')}}" class="single-btn">
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            ...
                                            <div class="hover-contents">
                                                <a href="{{route('product-details')}}" class="hover-image">
                                                    <img src="{{asset('front/assets/image/products/product-4.jpg')}}"
                                                        alt="">
                                                </a>
                                                <div class="hover-btns">
                                                    <a href="{{route('cart')}}" class="single-btn">
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            ...
                                            <div class="hover-contents">
                                                <a href="{{route('product-details')}}" class="hover-image">
                                                    <img src="{{asset('front/assets/image/products/product-7.jpg')}}"
                                                        alt="">
                                                </a>
                                                <div class="hover-btns">
                                                    <a href="{{route('cart')}}" class="single-btn">
                        ...
                        {"breakpoint":320, "settings": {"slidesToShow": 1} }
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                                        ...
                                                        <div class="hover-contents">
                                                            <a href="{{route('product-details')}}" class="hover-image">
                                                                <img src="{{asset('front/assets/image/products/product-5.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                            <div class="hover-btns">
                                                                <a href="{{route('cart')}}" class="single-btn">
                                        ...
                                        <div class="single-slide">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                                        <img src="{{asset('front/assets/image/products/product-6.jpg')}}"
                                                            alt="">
                                                        <div class="hover-contents">
                                                            <a href="{{route('product-details')}}" class="hover-image">
                                                                <img src="{{asset('front/assets/image/products/product-7.jpg')}}"
                                        ...
                                        <div class="single-slide">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                                        <img src="{{asset('front/assets/image/products/product-8.jpg')}}"
                                                            alt="">
                                                        <div class="hover-contents">
                                                            <a href="{{route('product-details')}}" class="hover-image">
                                                                <img src="{{asset('front/assets/image/products/product-9.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                            <div class="hover-btns">
                                                                <a href="{{route('cart')}}" class="single-btn">
                                        ...
                                        <div class="single-slide">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                                        <img src="{{asset('front/assets/image/products/product-10.jpg')}}"
                                                            alt="">
                                                        <div class="hover-contents">
                                                            <a href="{{route('product-details')}}" class="hover-image">
                                                                <img src="{{asset('front/assets/image/products/product-11.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                            <div class="hover-btns">
                                                                <a href="{{route('cart')}}" class="single-btn">
                                        ...
                                        <div class="single-slide">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                                        <img src="{{asset('front/assets/image/products/product-12.jpg')}}"
                                                            alt="">
                                                        <div class="hover-contents">
                                                            <a href="{{route('product-details')}}" class="hover-image">
                                                                <img src="{{asset('front/assets/image/products/product-11.jpg')}}"
                        ...
                        <div class="row space-db--30">
                            <div class="col-lg-8 mb--30">
                                <a href="" class="promo-image promo-overlay">
                                    <img src="{{asset('front/assets/image/bg-images/promo-banner-with-text-big.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                            <div class="col-lg-4 mb--30">
                                <a href="" class="promo-image promo-overlay">
                                    <img src="{{asset('front/assets/image/bg-images/promo-banner-with-text-2--small.jpg')}}"
                                        alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="home-right-block bg-white">
                            <div class="sb-custom-tab text-lg-left text-center">
                                <ul class="nav nav-tabs nav-style-2" id="myTab2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="shop-tab2" data-toggle="tab" href="#shop2"
                                            role="tab" aria-controls="shop2" aria-selected="true">
                                            ARTS & PHOTOGRAPHY
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="men-tab2" data-toggle="tab" href="#men2" role="tab"
                                            aria-controls="men2" aria-selected="true">
                                            CHILDREN'S BOOKS
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="woman-tab2" data-toggle="tab" href="#woman2" role="tab"
                                            aria-controls="woman2" aria-selected="false">
                                            BIOGRAPHIES
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane show active" id="shop2" role="tabpanel"
                                        ...
                                        <div class="product-slider product-list-slider multiple-row slider-border-multiple-row  sb-slick-slider"
                                            ...
                                            <div class="single-slide">
                                                <div class="product-card card-style-list">
                                                    <div class="card-image">
                                                        <img src="{{asset('front/assets/image/products/product-13.jpg')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="product-card--body">
                                                        <div class="product-header">
