            ...
            <div class="modal-dialog" role="document">
              ...
              "asNavFor": ".product-slider-nav"
                                    ...
                                    <div class="single-slide">
                                        <img src="{{asset("front/assets/image/products/product-details-1.jpg")}}"
                                            alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="{{asset("front/assets/image/products/product-details-2.jpg")}}"
                                            alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="{{asset("front/assets/image/products/product-details-3.jpg")}}"
                                            alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="{{asset("front/assets/image/products/product-details-4.jpg")}}"
                                            alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="{{asset("front/assets/image/products/product-details-5.jpg")}}"
                                            alt="">
                                    </div>
                                </div>
